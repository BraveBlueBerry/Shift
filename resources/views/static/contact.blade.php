    ...
    <div class="uk-width-1-3 container">
      ...
      <form class="uk-panel uk-panel-box uk-form form">
          <div class="uk-form-row">
              <input id="input_static" class="uk-width-1-1 uk-form-default" type="text" placeholder="Naam">
          </div>
          <div class="uk-form-row">
              <input id="input_static" class="uk-width-1-1 uk-form-default" type="text" placeholder="Email-adres">
          </div>
          <div class="uk-form-row">
              <textarea id="input_static" class="uk-textarea" rows="5" placeholder="Bericht"></textarea>
          </div>
          <div class="uk-form-row">
