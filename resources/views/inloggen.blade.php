...
<body>
  ...
  <div class="uk-navbar-right">
      <ul class="uk-navbar-nav">
          ...
          <li class="uk-active"><a href="">Inloggen</a></li>
          <li class="uk-parent"><a href="">Contact</a></li>
      </ul>
  </div>
</nav>
        <div class="uk-vertical-align uk-text-center uk-height-1-1">
            <div class="uk-vertical-align-middle" style="margin: auto; width: 250px;" >
                ...
                <form class="uk-panel uk-panel-box uk-form" style="background: #F0F0F0; border-radius: 10px;">
                    ...
                    <div class="uk-form-row">
                        <input class="uk-width-1-1 uk-form-default" style="
                          ...
                          border: 1px solid #ccc;
                          border-radius: 4px;
                          box-sizing: border-box;" type="text" placeholder="Password">
                    </div>
                    <div class="uk-form-row">
